    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="animate-fade-in-up-delay-4">
          <div className="bg-white rounded-lg p-8 shadow-md border-t-4 border-accent-teal pt-6 pb-6">
            <div className="w-14 h-14 bg-accent-teal rounded-full flex items-center justify-center ">
              <FaCompass className="text-textcolor-300" size={24} />
            </div>
            <h3 className="text-xl font-bold text-textcolor-100 mb-4">Personalized Career<br />Navigation</h3>
            <p className="text-textcolor-200 leading-relaxed text-sm">
        ...
        {/* Feature 2 */}
        <div className="animate-fade-in-up-delay-4">
          <div className="bg-white rounded-lg p-8 shadow-md border-t-4 border-primary-medium">
            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-6">
              <FaRocket className="text-primary-medium" size={24} />
            </div>
            <h3 className="text-lg font-bold text-textcolor-100 mb-3">Skills Acceleration</h3>
            <p className="text-textcolor-200 leading-relaxed text-sm">
        ...
        {/* Feature 3 */}
         <div className="animate-fade-in-up-delay-4">
          <div className="bg-white rounded-lg p-8 shadow-md border-t-4 border-secondary-orange">
            <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mb-6">
              <FaBriefcase className="text-secondary-orange" size={24} />
            </div>
            <h3 className="text-lg font-bold text-textcolor-100 mb-3">Real-World Exposure</h3>
            <p className="text-textcolor-200 leading-relaxed text-sm">
