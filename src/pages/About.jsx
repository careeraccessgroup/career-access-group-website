...
const About = () => (
  <div>
    ...
    <section className="py-20 bg-bgcolor-200">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-textcolor-100 mb-6">About Us</h1>
            <p className="text-textcolor-200 text-lg leading-relaxed">
          ...
          <div>
            <img src="/0V0A2042.jpg" alt="Career Access Group Team" className="rounded-lg shadow-lg w-full" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-3xl font-bold text-primary-medium mb-6">Our Vision</h2>
            <p className="text-textcolor-200 text-lg leading-relaxed">
          ...
          <div>
            <h2 className="text-3xl font-bold text-primary-medium mb-6">Our Mission</h2>
            <p className="text-textcolor-200 text-lg leading-relaxed">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg p-8 shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-textcolor-100 mb-4">Youth-Centric</h3>
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-textcolor-100 mb-4">Innovation</h3>
            <p className="text-textcolor-200 leading-relaxed">
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-textcolor-100 mb-4">Collaboration</h3>
            <p className="text-textcolor-200 leading-relaxed">
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-textcolor-100 mb-4">Integrity</h3>
            <p className="text-textcolor-200 leading-relaxed">
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-textcolor-100 mb-4">Impact-Driven</h3>
            <p className="text-textcolor-200 leading-relaxed">
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-textcolor-100 mb-4">Global Perspective</h3>
            <p className="text-textcolor-200 leading-relaxed">
    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-primary-medium mb-8">
